...
const tiers = [
  {
    ...
    models: ["XR13", "XR14", "XR15"],
    bestFor: "Budget-conscious homeowners who want Trane quality at the lowest cost",
  },
  {
    ...
    description:
      "The sweet spot of efficiency and value. Two-stage operation means more even temperatures, quieter operation, and lower monthly energy bills — without the premium price of variable speed.",
    models: ["XR15", "XR17", "XV18"],
    bestFor: "Homeowners who want meaningful efficiency gains and a noticeably more comfortable home",
    popular: true,
  },
  {
    name: "Comfort Series",
    ...
    description:
      "Trane's flagship line. Variable-speed compressor technology delivers whisper-quiet operation, precise temperature control, and the absolute lowest energy bills — the pinnacle of home comfort.",
    models: ["XV18", "XV20i", "XV21"],
